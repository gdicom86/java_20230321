...
public class Main {
	...
	public static void main(String[] args) {
		...
		wm.words.add(new Word("banana", "바나나"));
		wm.words.add(new Word("apple", "사과"));
		wm.words.add(new Word("glasses", "안경"));
		wm.words.add(new Word("coffee", "커피"));
		wm.words.add(new Word("straw", "빨대"));
		do {
			System.out.println();
